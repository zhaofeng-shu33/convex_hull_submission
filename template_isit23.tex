...
before the computational extensive experiments.
...
It seems that the authors in \cite{balestriero2021learning} confuse the interpolation error
with the probability of all samples in the convex position.
