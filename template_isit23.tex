...
\end{theorem}
The use of error bound $\epsilon$ is inspired by the formulation of Chernoff-Stein Lemma \cite{cover1999elements},
where the error exponent of one type of error is obtained on condition that the another type of error is controlled by $\epsilon$.
