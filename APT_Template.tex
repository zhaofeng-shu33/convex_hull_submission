...
\textcolor{red}{Without specific mention}, the $d$-dimensional distribution considered in this paper is spherically symmetric.
...
Specifically, in 2-D, $dist$ is the distance to the line passing $X_1$ and $X_2$.
The probability $H(x)=P(dist\geq x)$ represents the event that the distance $d$ is larger than $x$.
