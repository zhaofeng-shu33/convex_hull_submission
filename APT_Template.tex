...
The number of facets $F_N$ in the convex hull $H_N$ of these $N$ points is the 
...
When the training data are sampled from a Gaussian distribution,
the upper bound of this probability is applied to
explaining the phenomena of the dimensional curse \cite{balestriero2021learning}.
xxThat is?,
to achieve $p_{N,d} \to 0$, the number of samples $N$ grows faster than an exponential function of $d$.

The asymptotic expression of $\E[F_N]$ as $N\to \infty$
was studied firstly by R{\'e}nyi and Sulanke \cite{renyi1963konvexe}.
they considered
2-D Gaussian distribution and uniform distribution
in a convex region with an continuous curvature.
