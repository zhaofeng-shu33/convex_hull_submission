...
\begin{abstract}
This paper studies the convex hull of $d$-dimensional samples i.i.d. generated from spherically symmetric distributions. Specifically, we derive a complete integration formula for
...
with respect to the CDF of the radial distribution.
 ...
 the integration formula enables us to obtain the asymptotic value of the expected facet numbers
