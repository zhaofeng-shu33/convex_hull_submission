...
when the sample size $N$ takes the value $\lceil \frac{c^d}{k^{1/2}d^{3/2} \epsilon}\rceil$
and the dimension $d$ is large enough.
The relationship between $N$ and $d$ is exponential, as seen from \eqref{eq:N_c_d_3_2}.
