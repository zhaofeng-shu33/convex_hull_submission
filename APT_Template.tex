...
\shorttitle{On the expectation of hyperplanes for convex hulls of samples} % insert short title here for use in running head
...
\title{On the expectation of hyperplanes for convex hulls of samples from spherically symmetric distributions} % insert title - use \\ if it requires more than one line.
...
\keywords{Convell hull; spherically symmetric distribution; average number of faces}
