...
\begin{abstract}
 ...
 the integral formula enables us to investigate the asymptotic behavior of the expectation of facets
 for three types of spherically symmetric distributions.
 The asymptotic result is applied to estimate the sample complexity for machine learning algorithms.
\end{abstract}
