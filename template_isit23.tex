...
\end{proof}
The derivation of \eqref{eq:Ngd} is also valid if $N/d^2\to \infty$.
Therefore, combining \eqref{eq:Gamma_ratio} with \eqref{eq:N_N_d_d}, we obtain \eqref{eq:poly_E_F_N_d_infty}
from \eqref{eq:Ngd}.
