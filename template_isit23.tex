...
think that this is a misconception and that interpolation almost surely never occurs in high-dimensional spaces.
...
To address this issue analytically, we follow the geometric statistical model described above and then derive the sample size, which makes
interpolation almost surely occurs if the distribution is spherically symmetric.
This sample size, or sample complexity, can be used to determine the required number of samples
