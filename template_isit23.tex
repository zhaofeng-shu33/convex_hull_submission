...
The above background motivate us to investigate when the interpolation occurs
with large probability as we increase the training sample size.
...
It should be noted that the probability considered above is different from that of the convex position,
