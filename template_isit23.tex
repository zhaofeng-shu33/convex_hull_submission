...
an image recognition system trained on dog species cannot distinguish different species of cat since
...
they find that the newly generated or ($N+1$)-th sample falls in the convex hull of the first $N$ samples
...
we consider three distribution families, which cover mostly commonly used statistical models:
polynomial,
