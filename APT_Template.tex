...
Theorem \ref{thm:poly_tails} is an refinement of Dwyer's Theorem 1 for the expected number of facet \cite{dwyer1991convex}.
...
\end{theorem}
 ...
 Our improvement on the asymptotic value of $\E[F_N]$ is that we obtain its preceding term term involving only $d$.
...
\end{theorem}
 We can make some comparison between our result on $\E[F_N]$ and that of Dwyer's Theorem 3 \cite{dwyer1991convex}.
 The leading polynomial term $N^{\frac{d-1}{2k+d-1}}$ in \eqref{eq:efn_truncated_formula}
 is the same but other coefficients are missing in Dwyer's result. Therefore, we say that Dwyer only made the estimation of order
 while we obtained the asymptotic value of $\E[F_N]$.
...
\noindent This research was funded in part by the Shenzhen Science and Technology Program under Grant KQTD20170810150821146, National Key R\&D Program of China under Grant 2021YFA0715202 and High-end Foreign Expert Talent Introduction Plan under Grant G2021032013L.
