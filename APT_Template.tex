...
\shorttitle{On the expectation of facets in the convex hull of samples} % insert short title here for use in running head
...
\title{On the expected number of facets in the convex hull of samples from spherically symmetric distributions} % insert title - use \\ if it requires more than one line.
