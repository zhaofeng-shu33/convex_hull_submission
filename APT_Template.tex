...
The convex hull $H_N$ of these $N$ points is the smallest convex set containing them.
Various quantities related with $H_N$, including the number of vertices and facets, its volume, surface area,
were investigated
extensively by previous researchers \cite{schneider2008stochastic, barany2008random, hueter1999limit}.
The main aim of this paper is to provide a complete integral formula for $\E[F_N]$, the mathematical expectation
of the number of facets ($d-1$ dimensional faces) in $H_N$,
...
The estimation of $\E[F_N]$ can be used to give an upper bound
...
the upper bound of this probability is applied to
explain the phenomena of dimensional curse \cite{balestriero2021learning}.
That is,
...
He classified symmetric 2d distribution
